 ...
 *****************************************************************************
 **/
void FastMHelmholtzSolver(double **unknown, const int sz[2], double eta)   // !!!1
{
  double sigma[2] = {1., 1.};
 ...
 *****************************************************************************
 **/
void FastMHelmholtzSolver2(double **unknown, const int sz[2], double eta)   // !!!1
{
  double sigma[2] = {1., 1.};

  for (int i = 0; i < sz[0]; i++) {
    for (int j = 0; j < sz[1]; j++) {
      unknown[i][j] = - unknown[i][j]; 
    }
  }
