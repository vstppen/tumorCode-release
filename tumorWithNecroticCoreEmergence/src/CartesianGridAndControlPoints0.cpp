...
CartesianGridAndControlPoints0::CartesianGridAndControlPoints0(double x_min_, double x_max_, double y_min_, double y_max_, int I_, int J_, 
...
{   
    ...
    generate_boundary_points(filename_ctrlPts_, filename_ctrl_nxny_, filename_bdryPts_, recordOrNot);
...
CartesianGridAndControlPoints0::~CartesianGridAndControlPoints0()
{
...
void CartesianGridAndControlPoints0::safetyCheck()
{   
    // 1. 
...
void CartesianGridAndControlPoints0::getPoint1(double t, double &x, double &y)
{
    x = periodicCubicSplineGetS(M_x, alpha_x, beta_x, n_ctrl, t);
    y = periodicCubicSplineGetS(M_y, alpha_y, beta_y, n_ctrl, t);
}

void CartesianGridAndControlPoints0::getPoint2(double theta, double &x, double &y, double &tx, double &ty, double &nx, double &ny)
{
...
void CartesianGridAndControlPoints0::getPoint3(double theta, double &x, double &y, double &dx, double &dy, double &ddx, double &ddy)
{
    x = periodicCubicSplineGetS(M_x, alpha_x, beta_x, n_ctrl, theta);
    y = periodicCubicSplineGetS(M_y, alpha_y, beta_y, n_ctrl, theta);
...
void CartesianGridAndControlPoints0::generate_boundary_points(const std::string& filename_ctrlPts, const std::string& filename_ctrl_nxny, const std::string& filename_bdryPts, bool recordOrNot) 
{
    bdry_delta = M_2PI / M;
...
int CartesianGridAndControlPoints0::findClosestIndex(double p, double q)
{
    double dist = 10000.;
    double dist_temp;
    int i_temp;
...
void CartesianGridAndControlPoints0::findClosestPointRecursive(double p, double q, double t_start, double t_end, 
...
void CartesianGridAndControlPoints0::findClosestPoint(double p, double q, double &t0, double &x0, double &y0)
{
...
double CartesianGridAndControlPoints0::computeParameter(double x, double y) 
{
    double result, x0, y0;
...
bool CartesianGridAndControlPoints0::interiorOrNot(double p, double q, double x, double y, double nx, double ny) {
...
bool CartesianGridAndControlPoints0::interiorOrNot(double p, double q) {
    int i0 = findClosestIndex(p, q);
...
void CartesianGridAndControlPoints0::identifyInteriorGridNodes()
{   
 ...
 *****************************************************************************
 **/
void CartesianGridAndControlPoints0::identifyIrregularGridNodes()
{
...
void CartesianGridAndControlPoints0::identifyNearBdryGridNodes()
{
...
double CartesianGridAndControlPoints0::findXIntersectByBisection(double a, double b, double q, double tol)
{
...
double CartesianGridAndControlPoints0::findYIntersectByBisection(double p, double a, double b, double tol)
{
 ...
 *****************************************************************************************************
 **/
void CartesianGridAndControlPoints0::findIntersectionPoints()
{
    double tol = 1.0E-12; 
...
bool CartesianGridAndControlPoints0::isDuplicate(double** coor, int count, double x, double y, double epsilon = 1e-10) 
{
...
void CartesianGridAndControlPoints0::findGoodPoints(int i, int j, double** coor, double* u, double** solution, double (*g)(double, double), bool selfOrNot, int& count)
{   
    if (i >= 0 && i <= I && j >= 0 && j <= J) {
...
void CartesianGridAndControlPoints0::computeDDXandDN(double xi, double eta, double ddx[2], double dn[2])
{
...
void CartesianGridAndControlPoints0::computeJumps1(double x, double y, double tx, double ty, double nx, double ny, double psi, double d_phi, double du[2]) 
{
...
void CartesianGridAndControlPoints0::computeJumps2(double x, double y, double s, double tx, double ty, double nx, 
...
void CartesianGridAndControlPoints0::computeJumps(const double *phi_vec, const double *psi_vec, int K,
...
void CartesianGridAndControlPoints0::computeJumps2(double x, double y, double s, double tx, double ty,
...
void CartesianGridAndControlPoints0::computeJumps(double x0, double y0, double s, double tx, double ty, double nx, double ny, double f, double jmp2[3])
{
  computeJumps2(x0, y0, s, tx, ty, nx, ny, f, jmp2);
}

void CartesianGridAndControlPoints0::makeCorrection(double (*F)(double, double), double **b)
{
...
void CartesianGridAndControlPoints0::makeCorrection(double (*F)(double, double, double, double, int, int, double**, double, double), double** source, double **b)
{
...
bool CartesianGridAndControlPoints0::computeBoundaryValues(double **u, double xi, double eta, const double jump[6], double bdry_u[12])
{
  double x0 = Grid_x[0];
  double y0 = Grid_y[0]; 
...
void CartesianGridAndControlPoints0::extractDirichletBoundaryData(double **w, double (*F)(double, double), double *bdry_w_vec, int K) 
{
...
void CartesianGridAndControlPoints0::extractNeumannBoundaryData(double **w, double (*F)(double, double), double *bdry_wn_vec, int K)
{
    double j2[3], jump_w[6], bdry_w[12];
...
void CartesianGridAndControlPoints0::extractDirichletBoundaryData(double **w, double (*F)(double, double, double, double, int, int, double**, double, double), double** source, double *bdry_w_vec, int K) 
{
  double j2[3], jump_w[6], bdry_w[12];
...
void CartesianGridAndControlPoints0::extractNeumannBoundaryData(double **w, double (*F)(double, double, double, double, int, int, double**, double, double), double** source, double *bdry_wn_vec, int K)
{
    double j2[3], jump_w[6], bdry_w[12];
